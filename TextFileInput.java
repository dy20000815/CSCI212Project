...
public class TextFileInput  {
   ...
   public static String[] returnArray(String fileName) {
   	...
   	public static String[] returnStrArray (String fileName) throws NumberFormatException, IOException{
   		String[] list =new String [20];
   		TextFileInput tfi=new TextFileInput(fileName);
		String number =tfi.readLine();
		StringTokenizer myTokens = new StringTokenizer(number,",");
		int i=0;
		while(number!=null) {
			myTokens = new StringTokenizer(number,",");
			int j=0;
